                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      ...
                      const rejectionReasonInput = document.querySelector(
                        'input[name="rejection_reason"]'
                      );
                      const approvalCommentsInput = document.querySelector(
                        'input[name="approval_comments"]'
                      );

                      if (
                        e.target.value === "Rejected" ||
                        e.target.value === "Waitlist"
                      ) {
