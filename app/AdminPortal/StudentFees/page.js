...
export default function StudentFeesPage() {
    ...
    const filteredFees = fees.filter((fee) => {
        const query = searchQuery.toLowerCase(); // Convert search input to lowercase for case-insensitive matching
        return (
            ...
            <div className={styles.contentContainer}>
                ...
                <div className={styles.tableWrapper}>
                    <table className={styles.table}>
                        <thead>
                            <tr>
                                {/* Render table headers dynamically and allow sorting */}
                        ...
                        <tbody>
                            {/* Render the sorted and filtered fees */}
                            {sortedFees.length > 0 ? (
                                sortedFees.map((fee) => (
                                    <tr key={fee.id}>
                                        <td>{fee.id}</td>
