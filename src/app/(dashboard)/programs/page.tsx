     ...
     return (
        <Box p="md">
          <Group justify="space-between" mb="md">
            ...
            <Button onClick={() => { setEditProgram(null), setModalOpen(true)}}>Add Program</Button>
       ...
       />
        ...
        <ScrollArea>
         <Table striped withTableBorder highlightOnHover>
           <Table.Thead>
             <Table.Tr>
             <Th sorted = {sortBy === 'programCode' } reversed = {reversed} onSort = {() => setSorting('programCode')}>
              Program Code
            </Th>
            <Th sorted={sortBy === 'programName'} reversed={reversed} onSort={() => setSorting('programName')}>
              Name
            </Th>
            <Th sorted={sortBy === 'programDescription'} reversed={reversed} onSort={() => setSorting('programDescription')}>
              Description
            </Th>
            <Th sorted={sortBy === 'duration'} reversed={reversed} onSort={() => setSorting('duration')}>
              Duration
            </Th>
            <Th sorted={sortBy === 'tuitionFee'} reversed={reversed} onSort={() => setSorting('tuitionFee')}>
              Tuition Fee
            </Th>
